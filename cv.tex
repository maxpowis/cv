...
\begin{tabular}{p{0.97\textwidth}}
  ...
  Throughout my career, I have endorsed various positions involving data governance, data architecture, data modeling (data vaulting, 
   dimensional modeling, unified star schemas, ...), data integration, system integration. reference/master data management and business 
...
\begin{tabular}{rl}
  \textsc{Data Modeling:}& Conceptual — ER/3NF — Data Vault — Dimensional (\faStarO{} \& Snowflake) — Canonical\\
