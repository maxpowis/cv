...
\begin{tabular}{ cx{12em} cx{12em} cx{12em} cx{12em} }
  \textsc{Phone} 
  & \textsc{Email} 
  & \textsc{Website} 
  & \textsc{Socials}\\
  \faMobilePhone{} \href{tel:0032499673767}{+32 499 67 37 67} 
  & \faEnvelopeO{} \href{mailto:max@maxpowx.com}{max@maxpowx.com} 
  & \faFirefox{} \href{https://max.pow.is}{max.pow.is} 
  & \faLinkedin{} \href{https://www.linkedin.com/in/maxpowis/}{linkedin}\\
  & % \faEnvelope{} \href{mailto:max@pow.is}{max@pow.is}
  & \faFirefox{} \href{https://www.maxpowx.com}{maxpowx.com}
...
\begin{tabular}{p{0.97\textwidth}}
  I am passionate about data and technology. 
   ...
   for reuse across various data disciplines.\medskip
