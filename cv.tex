...
\newcommand{\hrefNew}[1]{\href[pdfnewwindow=true]{#1}}
\fancyfoot[R]{\hrefNew{\getreleaseurl}{\getreleaseversion}~--~\today}
...
\begin{tabular}{ cx{14em} cx{14em} cx{14em} }
  ...
  & \faGlobe{} \hrefNew{https://max.pow.is}{max.pow.is} 
  & \faLinkedin{} \hrefNew{https://www.linkedin.com/in/maxpowis/}{linkedin}\\
  \faMobile*{} \href{tel:0032499673767}{+32 499 67 37 67} 
  & \faGlobe{} \hrefNew{https://www.maxpowx.com}{maxpowx.com}
  & \faGithub{} \hrefNew{https://github.com/maxpowis}{github} \faTwitter{} \hrefNew{https://twitter.com/maxpowis}{twitter}
\end{tabular}
\end{center}
...
\begin{longtable}{p{3.5cm}|p{13.5cm}}
  \joblogcurrent{Freelance Data Expert}{maxPowX}{Brussels, BE}{2019-01-07}{%
    ...
    master data management and business analytics.%
  }{}
...
\begin{longtable}{p{3.5cm}|p{13.5cm}}
  \joblog{Post-bachelor E-Design}{HoGent\gape{\footnotemark[1]}}{Aalst, BE}{2005-09-01}{2006-06-30}{%
    Coursework included Multimedia Authoring, e-Business, Web design \& development, CMS and more.\\%
...
\begin{longtable}{p{3.5cm}|p{13.5cm}}
  \joblogcurrent{Data Expert}{SaaS Company}{Flemish region, BE}{2023-02-01}
    {Contributed to finding a consensus on a corporate-wide definition of key business metrics;\\%
    Defined the vision for the revamp of the data platform architecure principles, guidelines and standards.\\%
    Designed the dimensional model and guided the implementation of the metrics in PowerBI dashboards following established principles.}
    {\sotagarch{Data Platform Architecture} \sotagtech{Azure} \sotagtech{Snowflake} \sotagtech{PowerBI}}

  \joblog{Data Governance Lead Architect}{Portuguese Telco}{Lisbon, PT}{2022-05-01}{2022-12-15}
    {Architected the 9 core Data Governance capabilities and functions supporting the Data Mesh strategy of the organisation\\%
  ...
  \joblog{Data Governance Expert}{German Telco}{Düsseldorf, DE}{2022-04-01}{2022-11-15}
    {Define the architectural vision for a transition towards a Hybrid Data Governance Platform (involving mutiple data governance technology components)\\%
  ...
  \joblog{Data Vault Architect}{Insurance C°}{Brussels, BE}{2014-11-01}{2018-03-31}
    {Designed, engineered and delivered a data vault and various role-based dashboards serving the needs of 120+ IT project management stakholders\\%
  ...
  \joblog{Solution Architect \& Engineer}{Non-profit Organisation}{Brussels, BE}{2013-07-01}{2013-08-01}
    {Pragmatic solution for accouting quality controls and budgeting dashboards. Blended in-house tools and smart methods.}
  ...
  \joblog{Data Vault Architect}{International Bank}{Brussels, BE}{2012-10-01}{2013-07-01}
    {My first encounters with data vaulting. Fully automated and integrated in the enterpise application and security architecture}
  ...
  \joblog{EAI -- Senior Application Designer}{International Bank}{Brussels, BE}{2011-06-15}{2012-09-30}
    ...
    functional and technical documents for application components in scope of the delivery. Developed stand-alone%
      java components and supported development of WMB and WAS GUI components.}
...
\begin{tabular}{rl}
  ...
  &Certified Data Vault 2 Practioner (CDVP2) -- Dan Lindstedt (\hrefNew{https://max.pow.is/assets/5_2_12900_1435331244_CDVP2_Certificate.pdf}{certificate})\\
