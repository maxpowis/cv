...
\pagestyle{fancy}
\fancyfoot[L]{\faMeanpath{} Max Powis}
...
\vspace{0.5em}
\begin{tabular}{rl}
  \textsc{Phone:}     & \faMobilePhone{} \href{tel:0032499673767}{+32 499 67 37 67}\\
  \textsc{Email:}     & \faEnvelopeO{} \href{mailto:max@maxpowx.com}{max@maxpowx.com}\\
%                      | \faEnvelope{} \href{mailto:max@pow.is}{max@pow.is}\\
  \textsc{Website:}   & \faFirefox{} \href{https://max.pow.is}{https://max.pow.is}
                      | \faFirefox{} \href{https://www.maxpowx.com}{https://www.maxpowx.com}\\
  \textsc{Socials:}   & \faLinkedin{} \href{https://www.linkedin.com/in/maxpowis/}{linkedin}
...
\begin{tabular}{p{0.9\textwidth}}
  I am passionate about data and technology. 
   ...
   for reuse across various data disciplines.\\[4pt]
  Throughout my career, I have endorsed various positions involving data architecture, data modeling (data vaulting, 
   dimensional modeling, ...), data integration, system integration. reference/master data management and business 
