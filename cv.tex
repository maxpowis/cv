...
\newcommand{\joblog}[5]{\textsc{\displayshortmonth{#4} -- \displayshortmonth{#5}} & \large\sffamily \textbf{#1} at \textbf{#2}, \small{#3}\\\textit{(\displaymonthsdiff{#4}{#5} )}}
\DTMsavenow{now}
...
\begin{tabular}{p{0.9\textwidth}}
  I'm a data engineer with deep functional and technical expertise in a wide range of data matters: data architecture, 
   data modeling, data integration, system integration, reference data, master data management and business analytics. \\\\
...
\section{Education}
\begin{longtable}{r|p{0.72\textwidth}}
  \joblog{Post-bachelor}{Hogeschool Gent Departement Bedrijfskunde Aalst}{Aalst, BE}{2005-09-01}{2006-06-30}
    &Post-bachelor E-design. Mainly a great opportunity to get comfortable at speaking Dutch.\\&\\
    &Coursework included Multimedia Authoring, e-Business, Web design \& development, CMS and more.\\\sep

  \joblog{Bachelor}{Haute école d’Enseignement Supérieur de Namur (IESN)}{Namur, BE}{2002-09-01}{2005-06-30}
    &Bachelor of Computer Science option Management.\\&\\
